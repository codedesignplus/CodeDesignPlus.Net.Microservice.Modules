...
using CodeDesignPlus.Net.Microservice.Modules.gRpc.Services;
...
builder.Services.AddMongo<CodeDesignPlus.Net.Microservice.Modules.Infrastructure.Startup>(builder.Configuration);
